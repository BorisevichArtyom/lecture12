...
import by.itacademy.javaenterprise.connection.DataSource2;
...
public class UserDaoImplem implements UserDao<User> {
    ...
    private DataSource2 connect;
    private UserDaoImplem(DataSource2 connect) {
    ...
    public static int FindIdUserByEmail(User user) {
       try (Connection connection = DataSource2.getDS().getConnection();
